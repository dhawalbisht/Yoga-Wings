          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="h-full pr-6">
              <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                Unroll your mat, breathe in the moment, and let each asana be a love letter to your body. In the quietude of yoga, find solace, strength, and a dance with the divine. 🌙💖
              </p>
