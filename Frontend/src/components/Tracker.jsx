...
function Tracker() {
    ...
    return (
        <>
            <Header />
            <div
                className='flex justify-center items-center min-h-screen mt-12 bg-gray-200'
                style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
            >
                <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-md w-4/5 max-w-4xl overflow-auto max-h-screen">
