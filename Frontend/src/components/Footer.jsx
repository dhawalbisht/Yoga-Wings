      ...
      <footer className="w-full text-gray-700 bg-gray-100 body-font">
        <div
          ...
          <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            <p className="mt-2 text-sm text-gray-500">Our Social media</p>
            <div className="mt-4">
              <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                <a href='https://youtu.be/f2lnZan6GGU?si=Gr_kgixCy8eQHJyg' className="text-gray-500 cursor-pointer hover:text-gray-700">
                ...
                <a href='https://www.instagram.com/reel/C6iMuzzLEmr/?igsh=MWx6bno1YXZjczdmbg==' className="ml-3 text-gray-500 cursor-pointer hover:text-gray-700">
          ...
          <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
            ...
            <div className="w-full px-4 lg:w-1/4 md:w-1/2">
              ...
              <nav className="mb-10 list-none">
                ...
                <li className="mt-3">
                  <a className="text-gray-500 cursor-pointer hover:text-gray-900">+91 9045546824</a>
                </li>
              </nav>
            </div>
          </div>
        ...
        <div className="bg-gray-300">
          <div className="container px-5 py-4 mx-auto">
            <p className="text-sm text-gray-700 capitalize xl:text-center">© 2024 Yoga-Wings | All rights reserved </p>
          </div>
        </div>
      </footer>
